"""
MobileNetV2 architecture for endometriosis classification.

Implements transfer learning from ImageNet with a lightweight
architecture suitable for resource-constrained federated clients.
"""
...
def build_mobilenetv2(
    ...
    """
    Build MobileNetV2 model with ImageNet pre-trained weights.
...
def get_gradcam_target_layer() -> str:
    ...
    For MobileNetV2, the 'out_relu' layer is the final ReLU activation
    providing the last spatial feature maps before pooling.
